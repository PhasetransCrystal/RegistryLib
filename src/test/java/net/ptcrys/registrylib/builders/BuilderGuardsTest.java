...
class BuilderGuardsTest {
    ...
    private static final List<String> STANDALONE_BUILDERS = List.of(
            "net.ptcrys.registrylib.builders.EnchantmentBuilder",
            "net.ptcrys.registrylib.builders.RecipeTypeBuilder",
            "net.ptcrys.registrylib.worldgen.WorldgenFeatureBuilder",
            "net.ptcrys.registrylib.crop.CropBuilder");
    ...
    void abstractBuilderAlsoHasRegisteredField() {
        Class<?> clazz = loadOrSkip("net.ptcrys.registrylib.builders.AbstractBuilder");
        Field field = findDeclaredField(clazz, "registered");
