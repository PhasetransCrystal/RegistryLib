...
class BuilderGuardsTest {
    ...
    private static final List<String> STANDALONE_BUILDERS = List.of(
            "net.phasetranscrystal.registrylib.builders.EnchantmentBuilder",
            "net.phasetranscrystal.registrylib.builders.RecipeTypeBuilder",
            "net.phasetranscrystal.registrylib.worldgen.WorldgenFeatureBuilder",
            "net.phasetranscrystal.registrylib.crop.CropBuilder");
    ...
    void abstractBuilderAlsoHasRegisteredField() {
        Class<?> clazz = loadOrSkip("net.phasetranscrystal.registrylib.builders.AbstractBuilder");
        Field field = findDeclaredField(clazz, "registered");
