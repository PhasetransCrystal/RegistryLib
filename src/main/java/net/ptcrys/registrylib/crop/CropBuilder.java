package net.ptcrys.registrylib.crop;

import net.ptcrys.registrylib.RegistryCore;
import net.ptcrys.registrylib.annotations.StandardAPI;
import net.ptcrys.registrylib.datagen.loot.RegistryLibBlockLootTables;
...
public final class CropBuilder<P> {
    ...
    private Consumer<net.ptcrys.registrylib.builders.ItemBuilder<BlockItem, RegistryCore>> seedConfig = _builder -> {};
    ...
    public CropBuilder<P> seedItem(
                                   Consumer<net.ptcrys.registrylib.builders.ItemBuilder<BlockItem, RegistryCore>> seedConfig) {
    ...
    public BlockEntry<RegistryLibCropBlock> register() {
        ...
        net.ptcrys.registrylib.builders.ItemBuilder<BlockItem, RegistryCore> seedBuilder = core.item(name + "_seeds", p -> new RegistryLibCropSeedsItem(() -> cropRef[0].get(), p));
