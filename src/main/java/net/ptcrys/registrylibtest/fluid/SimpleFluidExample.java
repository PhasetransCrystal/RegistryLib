package net.ptcrys.registrylibtest.fluid;

import net.ptcrys.registrylib.util.entry.FluidEntry;
 ...
 * net.ptcrys.registrylibtest.builder.ModFluidBuilder}，直接调用 {@code .langCn()}。 {@code
