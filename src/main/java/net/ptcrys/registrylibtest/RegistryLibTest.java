...
import net.ptcrys.registrylibtest.advancement.FullAdvancementExample;
import net.ptcrys.registrylibtest.advancement.SimpleAdvancementExample;
import net.ptcrys.registrylibtest.block.FullBlockExample;
import net.ptcrys.registrylibtest.block.SimpleBlockExample;
import net.ptcrys.registrylibtest.blockentity.FullBlockEntityExample;
import net.ptcrys.registrylibtest.blockentity.SimpleBlockEntityExample;
import net.ptcrys.registrylibtest.crop.SimpleCropExample;
import net.ptcrys.registrylibtest.enchantment.FullEnchantmentExample;
import net.ptcrys.registrylibtest.enchantment.SimpleEnchantmentExample;
import net.ptcrys.registrylibtest.entity.FullEntityExample;
import net.ptcrys.registrylibtest.entity.SimpleEntityExample;
import net.ptcrys.registrylibtest.fluid.FullFluidExample;
import net.ptcrys.registrylibtest.fluid.SimpleFluidExample;
import net.ptcrys.registrylibtest.gametest.RegistryLibFeatureGameTests;
import net.ptcrys.registrylibtest.gametest.RegistryLibGameTestSupport;
import net.ptcrys.registrylibtest.gametest.RegistryLibStateGameTests;
import net.ptcrys.registrylibtest.item.FullItemExample;
import net.ptcrys.registrylibtest.item.SimpleItemExample;
import net.ptcrys.registrylibtest.recipe.FullRecipeExample;
import net.ptcrys.registrylibtest.recipe.MultiInputRecipeExample;
import net.ptcrys.registrylibtest.recipe.SimpleAddRecipeExample;
import net.ptcrys.registrylibtest.recipe.SimpleIngredientTypeExample;
import net.ptcrys.registrylibtest.recipe.SimpleRecipeExample;
import net.ptcrys.registrylibtest.state.SimpleStateExample;
import net.ptcrys.registrylibtest.worldgen.SimpleWorldgenExample;
 ...
 *
 * <p>
 * {@link ModRegistryCore} 继承 {@link net.ptcrys.registrylib.RegistryCore}， 重写了三个
...
public class RegistryLibTest {
    ...
    public RegistryLibTest(IEventBus modEventBus, ModContainer modContainer) {
        ...
        net.ptcrys.registrylib.util.DistExecutor.unsafeRunWhenOn(
    ...
    private static void onRegisterLayerDefinitions(
        ...
        event.registerLayerDefinition(
                net.ptcrys.registrylibtest.client.CrystalGuardianModel.LAYER_LOCATION,
                net.ptcrys.registrylibtest.client.CrystalGuardianModel::createBodyLayer);
    }
}
