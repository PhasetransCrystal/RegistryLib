...
public final class CropBuilder<P> {
    ...
    private Consumer<net.phasetranscrystal.registrylib.builders.ItemBuilder<BlockItem, RegistryCore>> seedConfig = _builder -> {};
    ...
    public CropBuilder<P> seedItem(
                                   Consumer<net.phasetranscrystal.registrylib.builders.ItemBuilder<BlockItem, RegistryCore>> seedConfig) {
    ...
    public BlockEntry<RegistryLibCropBlock> register() {
        ...
        net.phasetranscrystal.registrylib.builders.ItemBuilder<BlockItem, RegistryCore> seedBuilder = core.item(name + "_seeds", p -> new RegistryLibCropSeedsItem(() -> cropRef[0].get(), p));
