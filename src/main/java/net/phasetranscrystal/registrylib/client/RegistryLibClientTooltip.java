 ...
 * net.phasetranscrystal.registrylib.tooltip.SeparatorNode} 这种全宽分隔线）。独立框由 {@link
 * RegistryLibClientPanelComponent} 处理；分页控件由 {@link RegistryLibClientPageControl}
 * 处理；都是同一份原版组件列表里的独立条目。
 *
 * <p>
